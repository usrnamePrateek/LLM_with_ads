...
PLACEMENT_JUDGE_MODEL_NAME = "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B"
PLACEMENT_JUDGE_MAX_MODEL_LEN = 131072
PLACEMENT_JUDGE_MAX_TOKENS = 4096
PLACEMENT_JUDGE_GPU_MEMORY_UTILIZATION = 0.95
PLACEMENT_JUDGE_BATCH_SIZE = 32
