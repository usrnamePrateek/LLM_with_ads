...
from src.ad_retrieval.config import DEFAULT_INDEX_DIR
...
from src.generation.config import DEFAULT_OUTPUT_CSV, DEFAULT_QUERIES_PARQUET, QUERY_COLUMN, TOP_K
from src.generation.repository import AssignmentCsvRepository, QueryDatasetRepository
from src.generation.services import AssignTopAdService
