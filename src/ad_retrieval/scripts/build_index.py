...
from src.ad_retrieval.config import DEFAULT_ADS_JSONL, DEFAULT_INDEX_DIR
from src.ad_retrieval.embeddings.bge_m3 import BgeM3Encoder
from src.ad_retrieval.repository import JsonlAdRepository
from src.ad_retrieval.services import IndexAdsService
